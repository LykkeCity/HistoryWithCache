...
autorest --input-file=http://localhost:5000/swagger/v1/swagger.json --csharp --output-folder=./client/Lykke.Job.OperationsCache.Client/AutorestClient --namespace=Lykke.Job.OperationsCache.Client.AutorestClient