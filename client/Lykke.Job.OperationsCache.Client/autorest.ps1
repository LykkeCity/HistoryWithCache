...
autorest --input-file=http://localhost:5000/swagger/v1/swagger.json --csharp --output-folder=./AutorestClient --namespace=Lykke.Job.OperationsCache.Client.AutorestClient